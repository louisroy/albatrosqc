var App = (function()  {
	var autoplay = null; // A flag to be used in the anonymous function
	var audioTests = {
	...
	var onAppReady = function(ev) {
		...
		// Autoplay detection tests
		try {
			var audio = new Audio(); // Construct new Audio object
			var src = audio.canPlayType('audio/ogg') ? audioTests.ogg : audioTests.mp3; // Ternary statement determining the value of the src variable, which will be either ogg or mp3.
